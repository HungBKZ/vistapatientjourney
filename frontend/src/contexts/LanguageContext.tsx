...
const translations = {
  vi: {
    ...
    journey: {
      ...
      facebookPostLink2: 'Bài đăng Facebook (Campuchia)',
      facebookPostLink3: 'Lễ ký kết MOU (Facebook)',
      facebookPostLink4: 'Workshop Y tế số 1 (Facebook)',
      facebookPostLink5: 'Workshop Y tế số 2 (Facebook)',
      ...
      milestone6: {
        chapter: 'Cột mốc 06',
        title: 'Khởi động giai đoạn vươn ra quốc tế',
        subtitle: 'Triển khai và quảng bá giải pháp tại các phòng khám ở Campuchia',
        quote: 'Bước tiến quan trọng khẳng định năng lực của sinh viên Trường Đại học FPT trong việc đưa sản phẩm công nghệ Việt vươn ra khu vực.',
        description: 'Dự án VISTA đã chính thức tham gia chiến dịch truyền thông và giáo dục cộng đồng “Mắt Sáng Gìn Giữ Tinh Hoa” do Tập đoàn Y khoa VISI tổ chức tại Campuchia. VISTA đã giới thiệu ứng dụng mô phỏng thị giác tích hợp trí tuệ nhân tạo (AI) đến bác sĩ Chorng Reaksmey – Tổng giám đốc hệ thống Samaki Sen Sok Clinic và Neak Poan Diamond Clinic tại Phnom Penh. Đây là bước đi quan trọng trong kế hoạch triển khai đa ngôn ngữ (Việt - Anh - Khmer) nhằm hỗ trợ hiệu quả hơn cho các phòng khám quốc tế.',
        highlight1: 'Vươn sang Campuchia',
        highlight2: 'Hệ thống Samaki Sen Sok',
        highlight3: 'Chuẩn hóa đa ngôn ngữ',
      },
      milestone7: {
        chapter: 'Cột mốc 07',
        title: 'Hợp tác chiến lược cùng Tập đoàn Y khoa VISI',
        subtitle: 'Ký kết biên bản ghi nhớ (MOU) phát triển giải pháp VISTA',
        quote: 'Lễ ký kết MOU chính là dấu mốc quan trọng chứng minh tiềm năng thương mại hóa thực tế của dự án VISTA trong tương lai.',
        description: 'Dự án VISTA chính thức ký kết MOU hợp tác cùng Tập đoàn Y khoa VISI tại Lễ bảo vệ đồ án tốt nghiệp EXE401. Sự kiện này đánh dấu bước đi chiến lược giúp đưa dự án sinh viên Đại học FPT ứng dụng vào doanh nghiệp y tế thực tế, thúc đẩy hoàn thiện và phát triển ứng dụng AI mô phỏng thị giác.',
        highlight1: 'Ký kết MOU với VISI',
        highlight2: 'Trải nghiệm Khởi nghiệp',
        highlight3: 'Định hướng doanh nghiệp',
      },
      milestone8: {
        chapter: 'Cột mốc 08',
        title: 'Chính thức triển khai giải pháp VISTA',
        subtitle: 'Đánh dấu bước ngoặt vận hành đồng bộ tại 5 cơ sở thuộc Tập đoàn Y khoa VISI',
        quote: 'Hành trình đưa ứng dụng AI vào thực tế lâm sàng, giúp nâng cao chất lượng dịch vụ tư vấn và chăm sóc sức khỏe mắt tại các cơ sở y tế.',
        description: 'VISTA chính thức đưa giải pháp trải nghiệm thị giác tích hợp trí tuệ nhân tạo (AI) vào vận hành thực tế đồng bộ tại 5 cơ sở y tế thuộc hệ thống Tập đoàn Y khoa VISI. Bước tiến này giúp chuyển đổi quy trình tư vấn nhãn khoa thông thường thành trải nghiệm thị giác trực quan, giúp hàng ngàn bệnh nhân hiểu rõ tình trạng sức khỏe mắt của mình một cách sinh động nhất.',
        highlight1: 'Triển khai tại 5 cơ sở',
        highlight2: 'Vận hành đồng bộ',
        highlight3: 'Ứng dụng AI lâm sàng',
      },
      milestone9: {
        chapter: 'Cột mốc 09',
        title: 'Tối ưu hóa giải pháp qua Digital Workshop',
        subtitle: 'Thảo luận chuyên sâu cùng Ban lãnh đạo Tập đoàn Y khoa VISI',
        quote: 'Những phản hồi từ hội đồng chuyên môn và ban lãnh đạo chính là kim chỉ nam giúp VISTA tiếp tục cải tiến và phát triển giải pháp tối ưu nhất cho người bệnh.',
        description: 'VISTA vinh dự tham gia Mini Workshop "Kỷ nguyên số trong bối cảnh Y tế hiện đại" do Tập đoàn Y khoa VISI tổ chức. Nhóm đã giới thiệu ứng dụng mô phỏng bệnh lý mắt tích hợp AI và công nghệ Explainable AI (XAI) trong phân tích ảnh chụp đáy mắt giúp phát hiện bệnh võng mạc đái tháo đường, nhận được sự đánh giá cao và tư vấn cải tiến sâu sắc từ các chuyên gia hàng đầu.',
        highlight1: 'Workshop Y tế số',
        highlight2: 'Trình bày AI & XAI',
        highlight3: 'Góp ý từ chuyên gia',
      },
      milestone10: {
        chapter: 'Cột mốc 10',
        title: 'Thử nghiệm lâm sàng tại Bệnh viện Mắt Sông Tiền (Bến Tre)',
        subtitle: 'Tiên phong thử nghiệm nền tảng AI chẩn đoán võng mạc đái tháo đường',
        quote: 'Sự phối hợp chặt chẽ với các chuyên gia nhãn khoa hàng đầu tại Bến Tre mở ra chương mới trong việc ứng dụng AI phát hiện sớm võng mạc đái tháo đường.',
        description: 'Dự án VISTA chính thức bước vào giai đoạn thử nghiệm lâm sàng quan trọng tại Bệnh viện Mắt Sông Tiền (Bến Tre). Tại đây, đội ngũ phát triển đã trực tiếp làm việc, tiếp nhận các phản hồi chuyên môn quý báu từ đội ngũ bác sĩ chuyên khoa nhãn khoa đầu ngành. Điều này giúp tối ưu hóa thuật toán AI chẩn đoán hình ảnh đáy mắt, nâng cao độ chính xác và đảm bảo khả năng ứng dụng thực tế cao trong việc hỗ trợ sàng lọc bệnh võng mạc đái tháo đường cho người dân miền Tây.',
        highlight1: 'Thử nghiệm lâm sàng',
        highlight2: 'Phản hồi chuyên môn',
        highlight3: 'Tối ưu hóa chẩn đoán AI',
      },
      solution: {
  ...
  en: {
    ...
    journey: {
      ...
      facebookPostLink2: 'Facebook post (Cambodia)',
      facebookPostLink3: 'MOU Signing Ceremony (Facebook)',
      facebookPostLink4: 'Digital Workshop 1 (Facebook)',
      facebookPostLink5: 'Digital Workshop 2 (Facebook)',
      ...
      milestone6: {
        chapter: 'Milestone 06',
        title: 'Launch of International Expansion',
        subtitle: 'Deploying and promoting solutions at clinics in Cambodia',
        quote: 'An important step confirming FPT students\' capacity to bring Vietnamese tech products to the region.',
        description: 'VISTA participated in the "Bright Eyes, Preserving Heritage" campaign in Cambodia, introducing its AI vision simulation app to Dr. Chorng Reaksmey – Director of Samaki Sen Sok Clinic and Neak Poan Diamond Clinic in Phnom Penh. This milestone marks the start of sustainable international healthcare cooperation in Southeast Asia.',
        highlight1: 'Expanding to Cambodia',
        highlight2: 'Samaki Sen Sok System',
        highlight3: 'Multilingual Support',
      },
      milestone7: {
        chapter: 'Milestone 07',
        title: 'Strategic Cooperation with VISI Group',
        subtitle: 'Signing Memorandum of Understanding (MOU) for VISTA',
        quote: 'The MOU signing is an important milestone demonstrating VISTA\'s potential for real-world commercialization.',
        description: 'VISTA officially signed a Memorandum of Understanding (MOU) with VISI Medical Group at the EXE401 thesis defense. This event marks a strategic step in bringing FPT student projects into real healthcare businesses, accelerating the development of the AI-integrated vision app.',
        highlight1: 'MOU with VISI Group',
        highlight2: 'Entrepreneurial Journey',
        highlight3: 'Business Orientation',
      },
      milestone8: {
        chapter: 'Milestone 08',
        title: 'Official Deployment of VISTA Solutions',
        subtitle: 'Marking a milestone of synchronized operation at 5 VISI Group clinics',
        quote: 'The journey of bringing AI applications into clinical practice, improving the quality of consultation and eye care services.',
        description: 'VISTA officially deployed its AI-integrated visual experience solution synchronously across 5 clinics of VISI Medical Group. This step transforms standard ophthalmology consultations into interactive visual experiences, helping thousands of patients understand their eye health in the most vivid way.',
        highlight1: 'Deployed at 5 Clinics',
        highlight2: 'Synchronized Operation',
        highlight3: 'Clinical AI Application',
      },
      milestone9: {
        chapter: 'Milestone 09',
        title: 'Optimizing Solutions via Digital Workshop',
        subtitle: 'In-depth discussion with VISI Medical Group leadership',
        quote: 'Feedback from the advisory board and leadership acts as a compass guiding VISTA to continuously improve and build the best solutions for patients.',
        description: 'VISTA participated in the Mini Workshop "Digital Era in Modern Healthcare" organized by VISI Medical Group. The team presented its AI-integrated eye simulation app and Explainable AI (XAI) for diabetic retinopathy detection, receiving high appreciation and constructive guidance from top experts.',
        highlight1: 'Digital Workshop',
        highlight2: 'AI & XAI presentation',
        highlight3: 'Expert Board Feedback',
      },
      milestone10: {
        chapter: 'Milestone 10',
        title: 'Clinical Trials at Song Tien Eye Hospital (Ben Tre)',
        subtitle: 'Pioneering the AI platform for diabetic retinopathy diagnosis',
        quote: 'Close collaboration with leading ophthalmologists in Ben Tre opens a new chapter in applying AI for early diabetic retinopathy detection.',
        description: 'VISTA project officially entered a crucial clinical trial phase at Song Tien Eye Hospital (Ben Tre). The development team worked directly and received invaluable professional feedback from leading ophthalmology specialists. This collaboration helps optimize the AI algorithm for retinal fundus image analysis, improving diagnostic accuracy and ensuring high practical viability in supporting diabetic retinopathy screening for residents in the Mekong Delta.',
        highlight1: 'Clinical Pilot Test',
        highlight2: 'Expert Specialist Feedback',
        highlight3: 'Optimized AI Diagnosis',
      },
      solution: {
        badge: 'Core Solution',
  ...
  km: {
    ...
    journey: {
      ...
      facebookPostLink2: 'ប្រកាស Facebook (កម្ពុជា)',
      facebookPostLink3: 'ពិធីចុះហត្ថលេខាលើ MOU (Facebook)',
      facebookPostLink4: 'ប្រកាសសិក្ខាសាលា ១ (Facebook)',
      facebookPostLink5: 'ប្រកាសសិក្ខាសាលា ២ (Facebook)',
      ...
      milestone6: {
        chapter: 'វិស័យ ០៦',
        title: 'បើកដំណើរការការវាយលុកទីផ្សារអន្តរជាតិ',
        subtitle: 'ការអនុវត្ត និងផ្សព្វផ្សាយដំណោះស្រាយនៅគ្លីនិកក្នុងប្រទេសកម្ពុជា',
        quote: 'ជំហានដ៏សំខាន់មួយបញ្ជាក់ពីសមត្ថភាពរបស់និស្សិត FPT ក្នុងការនាំយកផលិតផលបច្ចេកវិទ្យាវៀតណាមទៅកាន់តំបន់។',
        description: 'គម្រោង VISTA បានចូលរួមក្នុងយុទ្ធនាការ "ភ្នែកភ្លឺ ថែរក្សាកេរដំណែល" នៅកម្ពុជា ដោយណែនាំកម្មវិធីត្រាប់តាមចក្ខុវិស័យ AI ទៅកាន់លោកវេជ្ជបណ្ឌិត Chorng Reaksmey – នាយកគ្លីនិក Samaki Sen Sok និងគ្លីនិក Neak Poan Diamond នៅភ្នំពេញ។ ព្រឹត្តិការណ៍នេះកត់សម្គាល់ការចាប់ផ្តើមនៃកិច្ចសហប្រតិបត្តិការថែទាំសុខភាពអន្តរជាតិប្រកបដោយនិរន្តរភាព។',
        highlight1: 'ពង្រីកទៅកាន់ទីផ្សារកម្ពុជា',
        highlight2: 'ចូលទៅជិតប្រព័ន្ធគ្លីនិកធំៗ',
        highlight3: 'ស្តង់ដារពហុភាសា (ខ្មែរ)',
      },
      milestone7: {
        chapter: 'វិស័យ ០៧',
        title: 'កិច្ចសហប្រតិបត្តិការគ្រប់ជ្រុងជ្រោយជាមួយ VISI Group',
        subtitle: 'ការចុះហត្ថលេខាលើ MOU ដើម្បីជំរុញដំណោះស្រាយ VISTA',
        quote: 'ការចុះហត្ថលេខាលើ MOU បើកឱកាសអភិវឌ្ឍន៍ដ៏ធំធេង និងបញ្ជាក់ពីសក្តានុពលពាណិជ្ជកម្មជាក់ស្តែងរបស់ VISTA។',
        description: 'គម្រោង VISTA បានចុះហត្ថលេខាលើអនុស្សរណៈនៃការយោគយល់គ្នា (MOU) ជាមួយសម្ព័ន្ធវេជ្ជសាស្ត្រ VISI Group។ នេះជាជំហានយុទ្ធសាស្ត្រដើម្បីអនុវត្តជាក់ស្តែងនូវដំណោះស្រាយ AI visual experience បង្កើតស្ពានចម្លងរវាងការស្រាវជ្រាវរបស់និស្សិត FPT និងតម្រូវការអាជីវកម្ម។',
        highlight1: 'ចុះហត្ថលេខាលើ MOU ជាមួយ VISI',
        highlight2: 'សក្តានុពលពាណិជ្ជកម្ម',
        highlight3: 'ការតភ្ជាប់អាជីវកម្មវេជ្ជសាស្ត្រ',
      },
      milestone8: {
        chapter: 'វិស័យ ០៨',
        title: 'ការដាក់ពង្រាយជាផ្លូវការនូវដំណោះស្រាយ VISTA',
        subtitle: 'កត់សម្គាល់ការប្រតិបត្តិការស្របគ្នាទាំង ៥ មូលដ្ឋាននៃ VISI Group',
        quote: 'ដំណើរការនាំយកបច្ចេកវិទ្យា AI ទៅប្រើប្រាស់ជាក់ស្តែង ជួយលើកកម្ពស់គុណភាពប្រឹក្សាយោបល់ និងការថែទាំភ្នែក។',
        description: 'គម្រោង VISTA បានដាក់ឱ្យដំណើរការជាផ្លូវការនូវដំណោះស្រាយ AI visual experience ស្របគ្នាទាំង ៥ មូលដ្ឋាននៃ VISI Medical Group។ ការវិវត្តនេះជួយបំប្លែងការប្រឹក្សាភ្នែកធម្មតាទៅជាបទពិសោធន៍ចក្ខុវិស័យអន្តរកម្ម ជួយអ្នកជំងឺយល់ច្បាស់ពីសុខភាពភ្នែករបស់ពួកគេ។',
        highlight1: 'ដាក់ពង្រាយនៅ ៥ មូលដ្ឋាន',
        highlight2: 'ប្រតិបត្តិការស្របគ្នាជាក់ស្តែង',
        highlight3: 'ការអនុវត្ត AI ក្នុងគ្លីនិក',
      },
      milestone9: {
        chapter: 'វិស័យ ០៩',
        title: 'ការបង្កើនប្រសិទ្ធភាពដំណោះស្រាយតាមរយៈ Digital Workshop',
        subtitle: 'ការពិភាក្សាស៊ីជម្រៅជាមួយគណៈគ្រប់គ្រងនៃសម្ព័ន្ធវេជ្ជសាស្ត្រ VISI Group',
        quote: 'មតិកែលម្អពីក្រុមប្រឹក្សាជំនាញនិងគណៈគ្រប់គ្រងគឺជាទ្រនិចចង្អុលបង្ហាញផ្លូវឱ្យ VISTA បន្តកែលម្អនិងអភិវឌ្ឍដំណោះស្រាយដ៏ល្អបំផុតសម្រាប់អ្នកជំងឺ។',
        description: 'VISTA មានកិត្តិយសចូលរួមក្នុង Mini Workshop "យុគសម័យឌីជីថលក្នុងបរិបទសុខាភិបាលទំនើប" ដែលរៀបចំឡើងដោយសម្ព័ន្ធវេជ្ជសាស្ត្រ VISI Group។ ក្រុមការងារបានណែនាំកម្មវិធីត្រាប់តាមជំងឺភ្នែកដែលរួមបញ្ចូល AI និងបច្ចេកវិទ្យា Explainable AI (XAI) ក្នុងការវិភាគរូបភាពបាតភ្នែកដើម្បីស្វែងរកជំងឺភ្នែកទឹកនោមផ្អែម ដោយទទួលបានការវាយតម្លៃខ្ពស់ និងការណែនាំកែលម្អយ៉ាងស៊ីជម្រៅពីអ្នកជំនាញឈានមុខគេ។',
        highlight1: 'Mini Workshop យុគសម័យឌីជីថល',
        highlight2: 'ការបង្ហាញ AI & XAI',
        highlight3: 'ការណែនាំកែលម្អពីអ្នកជំនាញ',
      },
      milestone10: {
        chapter: 'វិស័យ ១០',
        title: 'ការសាកល្បងគ្លីនិកនៅមន្ទីរពេទ្យភ្នែក Sông Tiền (Bến Tre)',
        subtitle: 'ឈានមុខក្នុងការសាកល្បងប្រព័ន្ធ AI វិនិច្ឆ័យជំងឺភ្នែកទឹកនោមផ្អែម',
        quote: 'កិច្ចសហការយ៉ាងជិតស្និទ្ធជាមួយអ្នកជំនាញភ្នែកឈានមុខគេនៅ Bến Tre បើកទំព័រថ្មីក្នុងការអនុវត្ត AI ដើម្បីរកឃើញជំងឺភ្នែកទឹកនោមផ្អែមទាន់ពេលវេលា។',
        description: 'គម្រោង VISTA បានឈានចូលដំណាក់កាលសាកល្បងគ្លីនិកដ៏សំខាន់ជាផ្លូវការនៅមន្ទីរពេទ្យភ្នែក Sông Tiền (Bến Tre)។ ក្រុមការងារអភិវឌ្ឍន៍បានធ្វើការដោយផ្ទាល់ និងទទួលបានមតិកែលម្អប្រកបដោយវិជ្ជាជីវៈពីគ្រូពេទ្យជំនាញភ្នែកឈានមុខគេ។ នេះជួយបង្កើនប្រសិទ្ធភាពក្បួនដោះស្រាយ AI ក្នុងការវិភាគរូបភាពបាតភ្នែក បង្កើនភាពត្រឹមត្រូវ និងធានាលទ្ធភាពអនុវត្តជាក់ស្តែងខ្ពស់ក្នុងការពិនិត្យសុខភាពភ្នែកជូនប្រជាពលរដ្ឋ។',
        highlight1: 'ការសាកល្បងគ្លីនិក',
        highlight2: 'មតិកែលម្អពីអ្នកជំនាញ',
        highlight3: 'បង្កើនប្រសិទ្ធភាពវិនិច្ឆ័យ AI',
      },
      solution: {
